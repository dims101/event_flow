  ...
  if (initialRooms.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center border border-dashed border-slate-800 rounded-2xl p-16 text-center bg-slate-900/10">
        ...
        <h3 className="text-lg font-semibold text-slate-300">Belum Ada Event</h3>
          ...
          >
            <div>
              <div className="flex items-start justify-between gap-4">
                <h3 className="font-bold text-lg text-white group-hover:text-indigo-400 transition duration-150">
                  {room.name}
                </h3>
            ...
            <div className="flex items-center gap-3 mt-6 pt-4 border-t border-slate-900">
              <Link
                ...
                className="flex-1 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-sm font-semibold rounded-xl text-center transition duration-150"
              >
                Kelola Event
              </Link>
              <button
                ...
                disabled={isPending}
                className="p-2.5 text-slate-500 hover:text-red-400 hover:bg-red-500/10 border border-slate-800 hover:border-red-500/20 rounded-xl transition duration-150"
                title="Hapus Event"
              >
                🗑️
              </button>
