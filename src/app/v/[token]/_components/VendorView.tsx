  ...
  return (
    <div className={`min-h-screen flex flex-col justify-between transition-colors duration-350 p-4 pb-6 select-none ${
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between border-b border-slate-900/60 pb-3">
          <div className="flex flex-col">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Event Kontrol</span>
            <h1 className="text-md font-extrabold text-white truncate max-w-[180px]">{roomName}</h1>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={togglePiP}
              type="button"
              className="px-2 py-0.5 rounded border border-slate-800 bg-slate-900 hover:bg-slate-800 text-[10px] text-slate-400 font-bold transition duration-150"
            ...
            {!isOnline ? (
              <span className="px-2 py-0.5 rounded-full border border-amber-500/20 bg-amber-500/10 text-amber-400 text-xs font-bold animate-pulse">
                OFFLINE
              </span>
            ) : connected ? (
        ...
        <div className="text-center py-2">
          ...
          <h2 className="text-xl md:text-2xl font-bold tracking-tight text-white line-clamp-2 px-4">
      ...
      <div className="flex flex-col items-center justify-center py-6">
        ...
        {isOvertime && (
          <span className="text-sm font-extrabold uppercase bg-white text-rose-700 px-3 py-1 rounded-full animate-bounce mt-4 shadow-lg shadow-rose-950/50">
            ⚠️ OVERTIME / TERLAMBAT
          </span>
        )}
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="border border-slate-900 bg-slate-900/60 rounded-xl p-4 min-h-[96px] flex flex-col justify-center">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">
            Instruksi Terakhir Divisi Anda:
          </span>
          {myMessages.length === 0 ? (
            ...
            <div className="space-y-1">
              <p className="text-sm text-indigo-300 font-extrabold leading-relaxed animate-in fade-in duration-300">
      ...
      {activeAlert && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-indigo-950/95 border-4 border-indigo-500 animate-in zoom-in-95 duration-150">
          ...
          <div className="relative z-10 text-center space-y-6 max-w-sm">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-indigo-400/30 bg-indigo-500/20 text-indigo-300 text-xs font-bold uppercase tracking-wider">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-white text-indigo-950 font-bold rounded-lg text-sm shadow-md"
            >
              Saya Mengerti
            </button>
          </div>
